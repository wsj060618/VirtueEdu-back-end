...
--
-- Host: 127.0.0.1    Database: virtue_edu_db
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='班级表';
...
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='员工表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `emp_expr` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工作经历';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `operate_log` (
  ...
  `cost_time` bigint unsigned DEFAULT NULL COMMENT '方法执行耗时',
  PRIMARY KEY (`id`)
...
--
-- Dumping routines for database 'virtue_edu_db'
--
...
-- Dump completed on 2026-05-16 12:40:35
